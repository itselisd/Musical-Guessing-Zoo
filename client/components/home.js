      ...
      <div>
          <div className="content">
            <p className='welcome'>
              ...
              <br/>
              If you see a great white baring its teeth under an animal that means its note is <em>sharp(#)</em> or if there is a hammerhead swimming underneath, its note is <em>flat(b)</em>.
              <br/>
            </p>
          </div>
        </div>
